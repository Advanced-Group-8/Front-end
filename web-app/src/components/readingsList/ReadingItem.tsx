    ...
    <div className='bg-white p-2 font-light'>
        ...
        <div className="flex justify-around">
          <div className="flex items-center">
            <p className='flex place-items-center p-2 gap-1'><img src={TemperatureIcon} alt="temperature icon" className="w-4 h-4" />Temperature: <span className='font-bold'>{reading.temperature}</span></p>
          </div>
          <span className='flex place-items-center p-2 gap-1'><img src={WaterDropIcon} alt="water drop icon" className="w-4 h-4" />Humidity: <span className='font-bold'>{reading.humidity}</span></span>
        </div>
